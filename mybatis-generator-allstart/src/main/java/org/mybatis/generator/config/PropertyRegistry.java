...
public class PropertyRegistry {
	...
	public static final String JAVA_TYPE_SUPER_MAPPER = "baseMapper";
	public static final String JAVA_TYPE_SUPER_SERVICE = "baseService";
	public static final String JAVA_TYPE_SUPER_SERVICE_IMPL = "baseServiceImpl";
	public static final String JAVA_TYPE_SUPER_CONTROLLER = "baseController";

	public static final String JAVA_TYPE_SERVICE_LOCATION = "serviceLocation";
	public static final String JAVA_TYPE_CONTROLLER_LOCATION = "controllerLocation";
	public static final String JAVA_TYPE_SERVICE_IMPL_LOCATION = "serviceImplLocation";
