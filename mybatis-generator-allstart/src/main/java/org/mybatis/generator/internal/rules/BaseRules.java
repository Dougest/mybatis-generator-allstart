...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateQueryList() {
    	...
    	return tableConfiguration.isQueryListStatementEnabled() &&
                (introspectedTable.hasBaseColumns() || introspectedTable
                         .hasBLOBColumns());
	}

	public boolean generateCountList() {
		if (isModelOnly) 
    		return false;
         
    	return tableConfiguration.isCountListStatementEnabled() &&
                (introspectedTable.hasBaseColumns() || introspectedTable
                         .hasBLOBColumns());
	}

	public boolean generateQueryListNoPage() {
		if (isModelOnly) 
    		return false;
         
    	return tableConfiguration.isQueryListNoPageStatementEnabled() &&
                (introspectedTable.hasBaseColumns() || introspectedTable
                         .hasBLOBColumns());
	}
