...
public class FullyQualifiedJavaType implements
    ...
    public static final FullyQualifiedJavaType getNewBaseMapper(String mapper) {
        return new FullyQualifiedJavaType(mapper); //$NON-NLS-1$
    }
    
    public static final FullyQualifiedJavaType getNewInterface(String location) {
        return new FullyQualifiedJavaType(location); //$NON-NLS-1$
    }
    
    
    
    public static final FullyQualifiedJavaType getNewBaseService() {
        return new FullyQualifiedJavaType("org.mybatis.generator.base.BaseService"); //$NON-NLS-1$
    }
    
    public static final FullyQualifiedJavaType getNewBaseServiceImpl() {
        return new FullyQualifiedJavaType("org.mybatis.generator.base.BaseServiceImpl"); //$NON-NLS-1$
    }
