 ...
 * the tool involves these steps: 该类是MyBatis生成器的主要接口。 典型的执行  * 该工具涉及以下步骤：
 * 
 * <ol>
 ...
 * <li>创建配置对象。 配置可以是a的结果解析XML配置文件，或者只能用Java创建。</ li>  *
 * <li>创建MyBatisGenerator对象</ li>  *<li>调用其中一个generate()方法</ li>
 * </ol>
 * usage<strong>core</strong>method:{@link #generate(ProgressCallback, Set, Set)},
 * and then
 * usage{@link Context#generateFiles(ProgressCallback, List, List, List)}method
 * generate content
 * 
