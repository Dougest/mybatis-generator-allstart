...
 * <li>创建MyBatisGenerator对象</ li>
 * <li>调用其中一个generate()方法</ li>
 * </ol>
 * 主要调用这个<strong>核心</strong>方法:{@link #generate(ProgressCallback, Set, Set)},
 * 具体步骤见方法内注释
 * 然后调用{@link Context#generateFiles(ProgressCallback, List, List, List)}方法来生成内容
