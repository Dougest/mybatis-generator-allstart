...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.Count4QueryListOnPageGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.QueryAllNoPageGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.QueryAllOnPageGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
	...
	protected XmlElement getSqlMapElement() {
		...
		// new add
		addQueryAllNoPageElement(answer);
		addCount4QueryListOnPageElement(answer);
		addQueryAllOnPageElement(answer);
		...
		if (ConstKey.isPrint) {
			...
			System.err.println("\n");
			System.out.println(answer.getFormattedContent(0));
		}

		return answer;
	}

	protected void addQueryAllOnPageElement(XmlElement parentElement) {
		// System.err.println(introspectedTable.getClass().getName());
		// if
		// (introspectedTable.getRules().generateUpdateByPrimaryKeySelective())
		// {
		AbstractXmlElementGenerator elementGenerator = new QueryAllOnPageGenerator();
		initializeAndExecuteGenerator(elementGenerator, parentElement);
		// }
	}

	protected void addCount4QueryListOnPageElement(XmlElement parentElement) {
		// System.err.println(introspectedTable.getClass().getName());
		// if
		// (introspectedTable.getRules().generateUpdateByPrimaryKeySelective())
		// {
		AbstractXmlElementGenerator elementGenerator = new Count4QueryListOnPageGenerator();
		initializeAndExecuteGenerator(elementGenerator, parentElement);
		// }
	}
	 ...
	 * {@link org.mybatis.generator.codegen.mybatis3.IntrospectedTableMyBatis3Impl}
	 * 
	 * @Describe
	 * @Author Dougest
	 * @Date 2018��9��21�� ����2:46:45
	 * @param parentElement
	 */
	protected void addQueryAllNoPageElement(XmlElement parentElement) {
		// System.err.println(introspectedTable.getClass().getName());
		// if
		// (introspectedTable.getRules().generateUpdateByPrimaryKeySelective())
		// {
		AbstractXmlElementGenerator elementGenerator = new QueryAllNoPageGenerator();
		initializeAndExecuteGenerator(elementGenerator, parentElement);
		// }
	}
